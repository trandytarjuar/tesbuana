...
$routes->group('penulis', function ($routes) {
    ...
    $routes->get('delete/(:any)', 'penulisController::delete/$1');
    $routes->post('save', 'penulisController::save');
    $routes->get('edit/(:any)', 'penulisController::edit/$1');
    $routes->post('update', 'penulisController::update');
  });
$routes->group('biodata', function ($routes) {
    $routes->get('/', 'biodataController::index');
    $routes->get('detail/(:any)', 'biodataController::detail/$1');
    $routes->get('bilangan', 'biodataController::bilangan');
    // $routes->get('create', 'penulisController::create');
    // $routes->get('delete/(:any)', 'penulisController::delete/$1');
    // $routes->post('save', 'penulisController::save');
    // $routes->get('edit/(:any)', 'penulisController::edit/$1');
